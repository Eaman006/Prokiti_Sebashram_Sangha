  ...
  return (
    ...
    <div className='bg-white text-black shadow-lg shadow-black/20 relative z-50'>
      <div className='flex justify-between items-center '>
        ...
        <div className='bg-purple-600 m-2 px-4 py-2 rounded-xl cursor-pointer md:text-lg font-bold text-white hover:bg-purple-800 hover:active:bg-purple-500 transition duration-300 ease-in-out shadow-purple-600/20 shadow-md flex items-center text-sm'><MdLocalGroceryStore />Store</div>
        <div className='md:hidden flex-col justify-center items-center text-sm hover:bg-purple-600 hover:active:bg-purple-600 cursor-pointer m-2 p-2'><IoIosMenu /> Menu</div>
      </div>
    </div>
  )
}
